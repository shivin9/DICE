...
python DICE.py --init_AE_epoch 1 --n_hidden_fea 32  --input_path "./dataset/" --dataset sepsis_ts --filename_train "datatrain.pkl" --filename_test "datavalid.pkl" --n_input_fea 44 --n_dummy_demov_fea 1 --lstm_layer 2 --lr 0.0001 --K_clusters 2 --iter 60 --epoch_in_iter 2 --lambda_AE 1.0 --lambda_classifier 1.0 --lambda_outcome 10.0 --lambda_p_value 1.0 --device cpu --batch_size 512 >> results_DICE.txt
python DICE.py --init_AE_epoch 1 --n_hidden_fea 32  --input_path "./dataset/" --dataset sepsis_ts --filename_train "datatrain.pkl" --filename_test "datavalid.pkl" --n_input_fea 44 --n_dummy_demov_fea 1 --lstm_layer 2 --lr 0.0001 --K_clusters 3 --iter 60 --epoch_in_iter 2 --lambda_AE 1.0 --lambda_classifier 1.0 --lambda_outcome 10.0 --lambda_p_value 1.0 --device cpu --batch_size 512 >> results_DICE.txt
python DICE.py --init_AE_epoch 1 --n_hidden_fea 32  --input_path "./dataset/" --dataset sepsis_ts --filename_train "datatrain.pkl" --filename_test "datavalid.pkl" --n_input_fea 44 --n_dummy_demov_fea 1 --lstm_layer 2 --lr 0.0001 --K_clusters 4 --iter 60 --epoch_in_iter 2 --lambda_AE 1.0 --lambda_classifier 1.0 --lambda_outcome 10.0 --lambda_p_value 1.0 --device cpu --batch_size 512 >> results_DICE.txt

python DICE.py --init_AE_epoch 1 --n_hidden_fea 32  --input_path "./dataset/" --dataset ards_ts --filename_train "datatrain.pkl" --filename_test "datavalid.pkl" --n_input_fea 89 --n_dummy_demov_fea 1 --lstm_layer 2 --lr 0.0001 --K_clusters 2 --iter 60 --epoch_in_iter 2 --lambda_AE 1.0 --lambda_classifier 1.0 --lambda_outcome 10.0 --lambda_p_value 1.0 --device cpu --batch_size 512 >> results_DICE.txt
python DICE.py --init_AE_epoch 1 --n_hidden_fea 32  --input_path "./dataset/" --dataset ards_ts --filename_train "datatrain.pkl" --filename_test "datavalid.pkl" --n_input_fea 89 --n_dummy_demov_fea 1 --lstm_layer 2 --lr 0.0001 --K_clusters 3 --iter 60 --epoch_in_iter 2 --lambda_AE 1.0 --lambda_classifier 1.0 --lambda_outcome 10.0 --lambda_p_value 1.0 --device cpu --batch_size 512 >> results_DICE.txt
python DICE.py --init_AE_epoch 1 --n_hidden_fea 32  --input_path "./dataset/" --dataset ards_ts --filename_train "datatrain.pkl" --filename_test "datavalid.pkl" --n_input_fea 89 --n_dummy_demov_fea 1 --lstm_layer 2 --lr 0.0001 --K_clusters 4 --iter 60 --epoch_in_iter 2 --lambda_AE 1.0 --lambda_classifier 1.0 --lambda_outcome 10.0 --lambda_p_value 1.0 --device cpu --batch_size 512 >> results_DICE.txt